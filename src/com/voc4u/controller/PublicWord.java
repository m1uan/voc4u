...
public class PublicWord {
	...
	public boolean isBasePrimary() {
		...
		// (CommonSetting.langType.getCrossBase() && mPoliticy ==
		// EPoliticy.PRIMAR) ||
		// (!CommonSetting.langType.getCrossBase() && mPoliticy ==
		// EPoliticy.SECUNDAR);
	}
	...
	public String toString() {
		return String.format("%s - %s (%d/%d)", getLern(), getNative(),
				mWord.getWeight(), mWord.getWeight2());
	}
	...
	public String getLern() {
		// return CommonSetting.langType.getCrossBase() ? mWord.getWord() :
		// mWord.getWord2();
		return mWord.getLern().replace("|", ",");
	}

	public String getNative() {
		// return CommonSetting.langType.getCrossBase() ? mWord.getWord2() :
		// mWord.getWord();
